/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/cloudflare-worker/src/env.d.ts` (hash: 1af87469222e16021ea983089a85430c)
// Runtime types generated with workerd@1.20260415.1 2026-04-19 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "ModuleKernelSqlite" | "AppStateAgentSqlite" | "RpcHostSqlite" | "HostedAgentRouteHostSqlite" | "HostedMcpRouteHostSqlite" | "StreamDurableObjectSqlite";
	}
	interface Env {
		...
		AI: Ai;
		SO_KERNEL: DurableObjectNamespace<import("./worker").ModuleKernelSqlite>;
		SO_APP_STATE: DurableObjectNamespace<import("./worker").AppStateAgentSqlite>;
		SO_RPC: DurableObjectNamespace<import("./worker").RpcHostSqlite>;
		SO_AGENT: DurableObjectNamespace<import("./worker").HostedAgentRouteHostSqlite>;
		SO_STREAM: DurableObjectNamespace<import("./worker").StreamDurableObjectSqlite>;
		SO_MCP: DurableObjectNamespace<import("./worker").HostedMcpRouteHostSqlite>;
	}
}
